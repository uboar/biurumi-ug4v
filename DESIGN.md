---
name: Neon-Ether Character Shell
colors:
  surface: '#100c1a'
  surface-dim: '#100c1a'
...
# Design System Specification: Neon-Ether Character Landing Shell

## 1. Overview & Creative North Star
**Creative North Star: "The Digital Character File"**

This project adapts the a-ug4v Neon-Ether system into a character landing page shell for PROJECT BIURUMI. It keeps the premium digital mood, dark layered surfaces, and neon accent language, but frames pages as character files: profile slots, worldbuilding panels, story chapters, and release notes that can be filled later.

The system rejects a generic marketing-page structure. The first screen should signal a character project, with a key-visual slot and structured dossier areas instead of broad sales copy.
